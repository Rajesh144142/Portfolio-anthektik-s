          ...
          {projectHandle.map((item, id) => (
            <div className=" w-[20rem]  p-1  rounded-xl  " key='id'>
              <div className="border-2 p-2 rounded-lg  w-[98%] ">
                ...
                <span className=" mt-3"> <h1 className="font-thin">Description : </h1>{item.description.slice(0, 150)}</span>
                <div className="flex justify-center items-center md:justify-start gap-5 mt-1">
                  <button className="">
                    ...
                    >
                      <BsGithub /> <span className="hidden md:block">Github repo</span>
                    </a>
                  </button>
                  <button className=" ">
                    <a
                      ...
                      className="flex items-center gap-1 border-2 bg-slate-100 p-2 "
                    >
                      <GiDeliveryDrone /> <span className=" hidden md:block">Live Preview</span>
                    </a>
                  </button>
                </div>
              </div>
