...
const Projects = () => {
  ...
  const { projects, loading1, error1 } = useSelector((state) => state.projects);
  ...
  if (loading1) {
    return <h1 className="text-center text-2xl font-bold pt-6 ">Loading...</h1>;
  }
  if (error1 != null) {
    return <h1>{error1}</h1>;
  }
  ...
  return (
    <div id="Projects" className="pt-24 mb-9 pb-5 m-auto w-[100%] ">
        ...
        <Slider {...settings}>
          {projects.map((item, id) => (
            <div className="  w-[20rem]  " key={id}>
              <div className="border-2 p-3 rounded-lg  w-[98%]   flex flex-col gap-3 ">
                ...
                <span className="h-[150px]">
                  ...
                  <p className=""  >{item.description.length<=140?<span>{item.description}...</span>:<span>{item.description.slice(0,140)}...</span>}</p>
                </span>
                <div className="flex justify-center items-center md:justify-start gap-5 mt-3 ">
                  <button className="">
                    <a
                      href={item.githubLink}
                      className="flex items-center rounded-lg gap-1 border-2 bg-slate-100 p-2 "
                    >
                      <BsGithub />{" "}
                  ...
                  <button className=" ">
                    <a
                      href={item.liveLink}
                      className="flex items-center gap-1 rounded-lg border-2 bg-slate-100 p-2 "
                    >
                      <GiDeliveryDrone />{" "}
